...
import ${groupId}.ws.ui.model.response.ErrorMessage;
...
public class AppExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleAnyException(UserServiceException ex,WebRequest request){
